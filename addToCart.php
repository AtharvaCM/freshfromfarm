<?php
    ...
    $query2 = "select img_src,product_name,product_price,qty from users,product,cart where users.user_id=cart.user_id and product.product_id=cart.product_id and username='$username';";
